...
public class IvyleavesBlock extends MsoModElements.ModElement {
	@ObjectHolder("mso:ivyleaves")
	public static final Block block = null;

	public IvyleavesBlock(MsoModElements instance) {
		super(instance, 47);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.VINE).hardnessAndResistance(0.5f, 0f).setLightLevel(s -> 0)
					.harvestLevel(-1).harvestTool(ToolType.HOE).setRequiresTool().speedFactor(0.7999999999999999f).notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("ivyleaves");
		}
