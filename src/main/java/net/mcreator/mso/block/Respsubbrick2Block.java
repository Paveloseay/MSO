...
import net.mcreator.mso.procedures.Respsubbrick2OnBlockRightClickedProcedure;
...
public class Respsubbrick2Block extends MsoModElements.ModElement {
	@ObjectHolder("mso:respsubbrick_2")
	public static final Block block = null;

	public Respsubbrick2Block(MsoModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("respsubbrick_2");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Submergedbricks3Block.block));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Respsubbrick2OnBlockRightClickedProcedure.executeProcedure(Stream
