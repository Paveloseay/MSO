...
public class YeetBlock extends MsoModElements.ModElement {
	@ObjectHolder("mso:yeet")
	public static final Block block = null;

	public YeetBlock(MsoModElements instance) {
		super(instance, 178);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("yeet"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mso:yeet"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 300, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.VINE)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("yeet");
		}
