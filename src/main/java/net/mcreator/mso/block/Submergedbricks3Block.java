...
public class Submergedbricks3Block extends MsoModElements.ModElement {
	@ObjectHolder("mso:submergedbricks_3")
	public static final Block block = null;

	public Submergedbricks3Block(MsoModElements instance) {
		super(instance, 155);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("submergedbricks_3");
		}
