...
import net.mcreator.mso.procedures.WeedgrasBlockDestroyedByPlayerProcedure;
...
public class WeedgrasBlock extends MsoModElements.ModElement {
	@ObjectHolder("mso:weed_grass")
	public static final Block block = null;

	public WeedgrasBlock(MsoModElements instance) {
		super(instance, 39);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(1.25f, 0f).setLightLevel(s -> 0)
					.harvestLevel(-1).harvestTool(ToolType.SHOVEL).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("weed_grass");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			WeedgrasBlockDestroyedByPlayerProcedure.executeProcedure(Stream
