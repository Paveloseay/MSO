...
import net.mcreator.mso.procedures.JunglelogBlockDestroyedByPlayerProcedure;
...
public class JunglelogBlock extends MsoModElements.ModElement {
	@ObjectHolder("mso:junglelog")
	public static final Block block = null;

	public JunglelogBlock(MsoModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			JunglelogBlockDestroyedByPlayerProcedure.executeProcedure(Stream
