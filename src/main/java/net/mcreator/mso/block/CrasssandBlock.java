...
public class CrasssandBlock extends MsoModElements.ModElement {
	@ObjectHolder("mso:crass_sand")
	public static final Block block = null;

	public CrasssandBlock(MsoModElements instance) {
		super(instance, 7);
	}
