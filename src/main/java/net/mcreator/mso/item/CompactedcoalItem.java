...
public class CompactedcoalItem extends MsoModElements.ModElement {
	@ObjectHolder("mso:compacted_coal")
	public static final Item block = null;

	public CompactedcoalItem(MsoModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("compacted_coal");
		}
