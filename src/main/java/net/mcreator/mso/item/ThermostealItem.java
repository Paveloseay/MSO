...
public class ThermostealItem extends MsoModElements.ModElement {
	@ObjectHolder("mso:thermosteal_helmet")
	public static final Item helmet = null;
	@ObjectHolder("mso:thermosteal_chestplate")
	public static final Item body = null;
	@ObjectHolder("mso:thermosteal_leggings")
	public static final Item legs = null;
	@ObjectHolder("mso:thermosteal_boots")
	public static final Item boots = null;

	public ThermostealItem(MsoModElements instance) {
		super(instance, 64);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{5, 9, 10, 4}[slot.getIndex()];
			}
			...
			public net.minecraft.util.SoundEvent getSoundEvent() {
				return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.shield.block"));
			}
		...
		elements.items.add(
				() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(MsoarmorsItemGroup.tab).isImmuneToFire()) {
					@Override
					@OnlyIn(Dist.CLIENT)
					public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
						BipedModel armorModel = new BipedModel(1);
						armorModel.bipedBody = new Modelthermosteal().bone3;
						armorModel.bipedLeftArm = new Modelthermosteal().bone;
						armorModel.bipedRightArm = new Modelthermosteal().bone2;
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "mso:textures/thermosteel_chestplate.png.png";
					}
				}.setRegistryName("thermosteal_chestplate"));
		elements.items.add(
				() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(MsoarmorsItemGroup.tab).isImmuneToFire()) {
					@Override
					@OnlyIn(Dist.CLIENT)
					public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
						BipedModel armorModel = new BipedModel(1);
						armorModel.bipedLeftLeg = new Modelthermostealleggings().bone;
						armorModel.bipedRightLeg = new Modelthermostealleggings().bone;
						armorModel.isSneak = living.isSneaking();
						armorModel.isSitting = defaultModel.isSitting;
						armorModel.isChild = living.isChild();
						return armorModel;
					...
					@Override
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "mso:textures/thermosteal_leggings.png";
					}
				}.setRegistryName("thermosteal_leggings"));
	}
	...
	// Exported for Minecraft version 1.15 - 1.16 with MCP mappings
	// Paste this class into your mod and generate all required imports
	public static class Modelthermosteal extends EntityModel<Entity> {
		private final ModelRenderer bone;
		private final ModelRenderer leftarm2;
		private final ModelRenderer cube_r1;
		private final ModelRenderer cube_r2;
		...
		public Modelthermosteal() {
			textureWidth = 64;
			textureHeight = 72;
			bone = new ModelRenderer(this);
			bone.setRotationPoint(0.5F, 24.0F, 0.0F);
			leftarm2 = new ModelRenderer(this);
			leftarm2.setRotationPoint(-13.0F, 0.5F, 3.0F);
			bone.addChild(leftarm2);
			setRotationAngle(leftarm2, 0.0F, 3.1416F, 0.0F);
			leftarm2.setTextureOffset(48, 53).addBox(-16.0F, -1.75F, 1.0F, 4.0F, 7.0F, 4.0F, 0.0F, false);
			leftarm2.setTextureOffset(30, 29).addBox(-14.5F, -1.75F, 4.5F, 2.0F, 9.0F, 1.0F, 0.0F, false);
			...
			body.setRotationPoint(0.0F, 0.0F, 0.0F);
			bone3.addChild(body);
			body.setTextureOffset(18, 29).addBox(-1.0F, 0.0F, 1.5F, 2.0F, 10.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(0, 13).addBox(3.75F, -1.5F, -2.5F, 1.0F, 10.0F, 5.0F, 0.0F, false);
			body.setTextureOffset(12, 13).addBox(-4.75F, -1.5F, -2.5F, 1.0F, 10.0F, 5.0F, 0.0F, false);
			body.setTextureOffset(12, 28).addBox(-1.0F, 0.0F, -2.5F, 2.0F, 10.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(4, 63).addBox(-4.0F, 0.25F, -2.0F, 8.0F, 8.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(4, 63).addBox(-4.0F, 0.25F, 1.0F, 8.0F, 8.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(4, 63).addBox(-4.0F, 0.25F, 1.0F, 8.0F, 8.0F, 1.0F, 0.0F, false);
			cube_r10 = new ModelRenderer(this);
			cube_r10.setRotationPoint(0.0F, 31.0F, 1.5F);
			body.addChild(cube_r10);
			...
			body.addChild(cube_r12);
			setRotationAngle(cube_r12, 0.0F, 0.0F, 0.3927F);
			cube_r12.setTextureOffset(11, 44).addBox(-13.0F, -21.0F, -4.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r12.setTextureOffset(21, 42).addBox(-13.0F, -21.0F, -8.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r13 = new ModelRenderer(this);
			cube_r13.setRotationPoint(0.0F, 27.0F, 5.5F);
			body.addChild(cube_r13);
			setRotationAngle(cube_r13, 0.0F, 0.0F, -0.3927F);
			cube_r13.setTextureOffset(42, 41).addBox(9.0F, -21.0F, -4.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r13.setTextureOffset(32, 41).addBox(9.0F, -21.0F, -8.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r14 = new ModelRenderer(this);
			cube_r14.setRotationPoint(0.0F, 25.0F, 5.5F);
			body.addChild(cube_r14);
			setRotationAngle(cube_r14, 0.0F, 0.0F, 0.3927F);
			cube_r14.setTextureOffset(12, 40).addBox(-13.0F, -21.0F, -4.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r14.setTextureOffset(36, 35).addBox(-13.0F, -21.0F, -8.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r15 = new ModelRenderer(this);
			cube_r15.setRotationPoint(0.0F, 25.0F, 5.5F);
			body.addChild(cube_r15);
			setRotationAngle(cube_r15, 0.0F, 0.0F, -0.3927F);
			cube_r15.setTextureOffset(23, 39).addBox(9.0F, -21.0F, -4.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r15.setTextureOffset(35, 38).addBox(9.0F, -21.0F, -8.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r16 = new ModelRenderer(this);
			cube_r16.setRotationPoint(0.0F, 23.0F, 5.5F);
			body.addChild(cube_r16);
			setRotationAngle(cube_r16, 0.0F, 0.0F, 0.3927F);
			cube_r16.setTextureOffset(40, 44).addBox(-13.0F, -21.0F, -4.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r16.setTextureOffset(0, 45).addBox(-13.0F, -21.0F, -8.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r17 = new ModelRenderer(this);
			cube_r17.setRotationPoint(0.0F, 23.0F, 5.5F);
			body.addChild(cube_r17);
			setRotationAngle(cube_r17, 0.0F, 0.0F, -0.3927F);
			cube_r17.setTextureOffset(30, 44).addBox(9.0F, -21.0F, -4.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			cube_r17.setTextureOffset(45, 19).addBox(9.0F, -21.0F, -8.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);
			bone2 = new ModelRenderer(this);
			bone2.setRotationPoint(-0.5F, 24.0F, 0.0F);
			rightarm3 = new ModelRenderer(this);
			rightarm3.setRotationPoint(13.0F, 0.5F, 3.0F);
			bone2.addChild(rightarm3);
			setRotationAngle(rightarm3, 0.0F, -3.1416F, 0.0F);
			rightarm3.setTextureOffset(48, 53).addBox(12.0F, -1.75F, 1.0F, 4.0F, 7.0F, 4.0F, 0.0F, true);
			rightarm3.setTextureOffset(30, 29).addBox(12.5F, -1.75F, 4.5F, 2.0F, 9.0F, 1.0F, 0.0F, true);
