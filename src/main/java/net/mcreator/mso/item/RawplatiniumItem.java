...
public class RawplatiniumItem extends MsoModElements.ModElement {
	@ObjectHolder("mso:raw_platinium")
	public static final Item block = null;

	public RawplatiniumItem(MsoModElements instance) {
		super(instance, 15);
	}
