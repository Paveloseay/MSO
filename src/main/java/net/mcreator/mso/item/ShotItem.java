...
import net.mcreator.mso.procedures.ShotWhileProjectileFlyingTickProcedure;
import net.mcreator.mso.entity.renderer.ShotRenderer;
...
public class ShotItem extends MsoModElements.ModElement {
	@ObjectHolder("mso:shot")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_shot").setRegistryName("projectile_shot");

	public ShotItem(MsoModElements instance) {
		super(instance, 144);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ShotRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(ShotItem.block);
		}
		...
		public void tick() {
			...
			ShotWhileProjectileFlyingTickProcedure.executeProcedure(Stream
