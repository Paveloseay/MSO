...
import net.mcreator.mso.procedures.ArcherBodyTickEventProcedure;
...
public class ArcherItem extends MsoModElements.ModElement {
	@ObjectHolder("mso:archer_helmet")
	public static final Item helmet = null;
	@ObjectHolder("mso:archer_chestplate")
	public static final Item body = null;
	@ObjectHolder("mso:archer_leggings")
	public static final Item legs = null;
	@ObjectHolder("mso:archer_boots")
	public static final Item boots = null;

	public ArcherItem(MsoModElements instance) {
		super(instance, 68);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDurability(EquipmentSlotType slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 96;
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(MsoarmorsItemGroup.tab)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedBody = new Modeloh().bone;
				armorModel.bipedLeftArm = new Modeloh().left;
				armorModel.bipedRightArm = new Modeloh().right;
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A79Perk: \u00A7e\u00A7l[Distance concentration]"));
				list.add(new StringTextComponent("\u00A76 improves bows performance"));
			}

			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "mso:textures/archer_equipment.png";
			}
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				ArcherBodyTickEventProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
						(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			}
		}.setRegistryName("archer_chestplate"));
	}

	// Made with Blockbench 4.3.1
	// Exported for Minecraft version 1.15 - 1.16 with MCP mappings
	// Paste this class into your mod and generate all required imports
	public static class Modeloh extends EntityModel<Entity> {
		...
		public Modeloh() {
			...
			left.setTextureOffset(16, 36).addBox(-1.0F, 7.25F, -2.0F, 4.0F, 1.0F, 4.0F, 0.0F, false);
			bone = new ModelRenderer(this);
			bone.setRotationPoint(0.0F, 24.0F, 0.0F);
			bone.setTextureOffset(40, 4).addBox(-4.5F, 10.25F, -2.5F, 9.0F, 2.0F, 1.0F, 0.0F, false);
			bone.setTextureOffset(40, 4).addBox(-4.5F, 10.25F, 1.5F, 9.0F, 2.0F, 1.0F, 0.0F, false);
			bone.setTextureOffset(41, 2).addBox(3.5F, 10.25F, -1.5F, 1.0F, 2.0F, 3.0F, 0.0F, false);
			bone.setTextureOffset(41, 2).addBox(-4.5F, 10.25F, -1.5F, 1.0F, 2.0F, 3.0F, 0.0F, false);
			cube_r1 = new ModelRenderer(this);
			cube_r1.setRotationPoint(0.0F, 24.0F, 0.0F);
			bone.addChild(cube_r1);
			setRotationAngle(cube_r1, 0.0F, 0.0F, -0.4363F);
			cube_r1.setTextureOffset(56, 33).addBox(6.75F, -26.7F, 2.55F, 3.0F, 7.0F, 0.0F, 0.0F, false);
			cube_r1.setTextureOffset(56, 33).addBox(6.45F, -27.05F, 2.05F, 3.0F, 7.0F, 0.0F, 0.0F, false);
			cube_r1.setTextureOffset(56, 33).addBox(7.05F, -27.35F, 2.25F, 3.0F, 7.0F, 0.0F, 0.0F, false);
			cube_r2 = new ModelRenderer(this);
			cube_r2.setRotationPoint(0.0F, 24.0F, 0.0F);
			bone.addChild(cube_r2);
			setRotationAngle(cube_r2, 0.0F, 0.0F, 0.5672F);
			cube_r2.setTextureOffset(0, 0).addBox(-11.1F, -22.1F, -1.5F, 1.0F, 1.0F, 3.0F, 0.0F, false);
			cube_r2.setTextureOffset(0, 50).addBox(-11.1F, -22.1F, 1.5F, 1.0F, 13.0F, 1.0F, 0.0F, false);
			cube_r2.setTextureOffset(0, 50).addBox(-11.1F, -22.1F, -2.5F, 1.0F, 13.0F, 1.0F, 0.0F, false);
			cube_r3 = new ModelRenderer(this);
			cube_r3.setRotationPoint(0.0F, 24.0F, 0.0F);
			bone.addChild(cube_r3);
			setRotationAngle(cube_r3, 0.0F, 0.0F, 1.1345F);
			cube_r3.setTextureOffset(0, 32).addBox(-20.5F, -9.25F, 1.75F, 8.0F, 2.0F, 1.0F, 0.0F, false);
