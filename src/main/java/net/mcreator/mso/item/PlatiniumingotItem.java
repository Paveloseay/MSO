...
public class PlatiniumingotItem extends MsoModElements.ModElement {
	@ObjectHolder("mso:platinium_ingot")
	public static final Item block = null;

	public PlatiniumingotItem(MsoModElements instance) {
		super(instance, 16);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("platinium_ingot");
		}
