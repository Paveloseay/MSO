...
public class SgllimyiItem extends MsoModElements.ModElement {
	@ObjectHolder("mso:sgllimyi")
	public static final Item block = null;

	public SgllimyiItem(MsoModElements instance) {
		super(instance, 181);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A79Rarity: \u00A76\u00A7lLegendary"));
