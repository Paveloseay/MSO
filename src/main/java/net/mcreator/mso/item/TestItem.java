...
import net.mcreator.mso.procedures.TestRangedItemUsedProcedure;
import net.mcreator.mso.entity.renderer.TestRenderer;
...
public class TestItem extends MsoModElements.ModElement {
	@ObjectHolder("mso:test")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_test").setRegistryName("projectile_test");

	public TestItem(MsoModElements instance) {
		super(instance, 162);
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					TestRangedItemUsedProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(ManadustItem.block);
		}
