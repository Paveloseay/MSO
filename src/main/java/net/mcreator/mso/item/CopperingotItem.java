...
public class CopperingotItem extends MsoModElements.ModElement {
	@ObjectHolder("mso:coppe_rbar")
	public static final Item block = null;

	public CopperingotItem(MsoModElements instance) {
		super(instance, 18);
	}
