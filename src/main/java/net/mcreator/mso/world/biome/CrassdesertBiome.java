...
import net.mcreator.mso.block.CrasssandBlock;
import net.mcreator.mso.block.CrassrockBlock;
import net.mcreator.mso.MsoModElements;

import com.google.common.collect.ImmutableList;

@MsoModElements.ModElement.Tag
public class CrassdesertBiome extends MsoModElements.ModElement {
	public static Biome biome;

	public CrassdesertBiome(MsoModElements instance) {
		super(instance, 9);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-14181693).setWaterFogColor(-14181693)
						.withSkyColor(7972607).withFoliageColor(-9554656).withGrassColor(-9554656).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(CrasssandBlock.block.getDefaultState(),
								CrassrockBlock.block.getDefaultState(), Blocks.COBBLESTONE.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
										ImmutableList.of(CrasssandBlock.block.getDefaultState(), CrassrockBlock.block.getDefaultState())))
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.MESA).depth(0.6f).scale(0.5f).temperature(2f)
						.downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("mso:crassdesert"));
			}
		}
	}
