...
import net.mcreator.mso.entity.renderer.FyshRenderer;
import net.mcreator.mso.MsoModElements;

@MsoModElements.ModElement.Tag
public class FyshEntity extends MsoModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.6f, 0.4f)).build("fysh").setRegistryName("fysh");

	public FyshEntity(MsoModElements instance) {
		super(instance, 171);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FyshRenderer.ModelRegisterHandler());
