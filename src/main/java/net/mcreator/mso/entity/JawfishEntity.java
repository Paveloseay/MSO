...
public class JawfishEntity extends MsoModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.6f, 0.4f)).build("jawfish").setRegistryName("jawfish");

	public JawfishEntity(MsoModElements instance) {
		super(instance, 183);
		FMLJavaModLoadingContext.get().getModEventBus().register(new JawfishRenderer.ModelRegisterHandler());
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 10, 5, 5));
	}
